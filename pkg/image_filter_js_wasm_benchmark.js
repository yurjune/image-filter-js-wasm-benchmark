/* @ts-self-types="./image_filter_js_wasm_benchmark.d.ts" */
...
export function gaussian_blur_wasm(pixels, width, height) {
    var ptr0 = passArray8ToWasm0(pixels, wasm.__wbindgen_malloc);
    var len0 = WASM_VECTOR_LEN;
    wasm.gaussian_blur_wasm(ptr0, len0, pixels, width, height);
}
 ...
 * @param {number} height
 */
export function sharpen_wasm(pixels, width, height) {
    var ptr0 = passArray8ToWasm0(pixels, wasm.__wbindgen_malloc);
    var len0 = WASM_VECTOR_LEN;
    wasm.sharpen_wasm(ptr0, len0, pixels, width, height);
}
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./image_filter_js_wasm_benchmark_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('image_filter_js_wasm_benchmark_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
